      ...
      <div className="relative container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Transform your business with strategic AI consulting. Get expert guidance on AI implementation, automation
            strategies, and digital transformation from a seasoned professional with proven results.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm border">
              ...
              <p className="text-gray-600 text-center">Years of AI Experience</p>
            </div>

            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm border">
              <Users className="h-12 w-12 text-green-600 mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-2">100+</h3>
              <p className="text-gray-600 text-center">Successful Projects</p>
            </div>

            <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-sm border">
              <TrendingUp className="h-12 w-12 text-purple-600 mb-4" />
              <h3 className="text-2xl font-bold text-gray-900 mb-2">300%</h3>
              <p className="text-gray-600 text-center">Average ROI Increase</p>
            </div>
          </div>
        </div>
      </div>
